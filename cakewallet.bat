@echo off
set cw_win_app_config=--monero --beldex --bitcoin --ethereum --polygon --nano --bitcoinCash --solana --tron --dogecoin --base
set cw_root=%cd%
...
for /d %%i in (cw_core cw_monero cw_beldex cw_bitcoin cw_ethereum cw_evm cw_polygon cw_nano cw_bitcoin_cash cw_solana cw_tron cw_base cw_arbitrum.) do (
    cd %%i
    call flutter pub get > nul
