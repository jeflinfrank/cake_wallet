...
class DevBeldexBackgroundSyncPage extends BasePage {
  final DevBeldexBackgroundSync viewModel;

  DevBeldexBackgroundSyncPage(this.viewModel);

  @override
  String? get title => "[dev] bdx background sync";
